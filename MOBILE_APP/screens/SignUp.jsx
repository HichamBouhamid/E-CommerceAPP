...
const validationSchema = Yup.object().shape({
  ...
  location: Yup.string()
  .min(3,'Enter a valid location address').required('Required'),
  username: Yup.string()
  .min(3,'Enter a valid username').required('Required'),
});
...
const SignUp = ({navigation}) => {
    ...
    const regisredUser = async(values)=> {
        setLoader(true);
        try {
            const endpoint = 'http://192.168.1.102:3000/api/register';
            const data = values;
      ...
      <SafeAreaView style={{marginHorizontal: 20}}>
        <View>
          ...
          <Formik
             ...
             onSubmit={values => regisredUser(values)}
          >
       ...
       <View style={styles.wrapper}>
        ...
        <Btn loader={loader} title={"S I G N  U P"} onPress={isValid ?handleSubmit: inValidForm  } isValid={isValid}/>
